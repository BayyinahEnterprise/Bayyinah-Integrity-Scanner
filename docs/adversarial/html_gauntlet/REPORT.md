> **Update 2026-04-28 (v1.1.2):** This HTML gauntlet now closes at **6/6 catch with full payload recovery**. The v1.1.1 baseline below is preserved as the historical record of why each mechanism was added. The scanner currently in production at https://bayyinah.dev catches every HTML fixture in this directory. See the v1.1.2 CHANGELOG entry for the full mechanism list and `tests/analyzers/test_html_v1_1_2_payloads.py` for the per-mechanism unit tests.
