...
- Type stack: Source Serif 4 display, Inter body, JetBrains Mono data. Source Serif 4 is Adobe's open-source variable serif designed for technical and scientific publishing. It reads like a research paper or an SEC filing, not editorial. Deliberately not Fraunces / Inter Tight / IBM Plex Mono.
